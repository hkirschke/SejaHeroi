...
namespace SejaHeroi.Controllers
{
  public class BaseController : Controller
  {
    ...
    protected readonly SejaHeroiContextAnimalUtil _SejaHeroiContextAnimalUtil = new SejaHeroiContextAnimalUtil();
    protected readonly SejaHeroiContextFichaUtil _SejaHeroiContextFichaUtil = new SejaHeroiContextFichaUtil();
